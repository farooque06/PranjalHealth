...
!(function(e, t) {
  ...
  var d = (function(n2) {
    ...
    function se2(t3, e3, n3, r3) {
      ...
      if (!r3 && (T2(e3), e3 = e3 || C2, E2)) {
        if (11 !== p3 && (u3 = Z2.exec(t3))) if (i3 = u3[1]) {
          ...
          } else if (f3 && (a3 = f3.getElementById(i3)) && v2(e3, a3) && a3.id === i3) return n3.push(a3), n3;
        } else {
    ...
    for (e2 in d2 = se2.support = {}, i2 = se2.isXML = function(e3) {
      ...
      if (T2(e3), d2.matchesSelector && E2 && !N2[t3 + " "] && (!s2 || !s2.test(t3)) && (!y2 || !y2.test(t3))) try {
      ...
      return y3 && !y3[S2] && (y3 = Ce2(y3)), v3 && !v3[S2] && (v3 = Ce2(v3, e3)), le2(function(e4, t3, n3, r3) {
        ...
        if (e4) {
          if (v3 || d3) {
            ...
            o3 = p3.length;
            while (o3--) (a3 = p3[o3]) && -1 < (i3 = v3 ? P2(e4, a3) : s3[o3]) && (e4[i3] = !(t3[i3] = a3));
          }
        } else p3 = Te2(p3 === t3 ? p3.splice(l3, p3.length) : p3), v3 ? v3(null, t3, p3, r3) : H2.apply(t3, p3);
      });
    }
    function Ee2(e3) {
    ...
    return me2.prototype = b2.filters = b2.pseudos, b2.setFilters = new me2(), h2 = se2.tokenize = function(e3, t3) {
      ...
      while (a3) {
        for (o3 in n3 && !(r3 = _2.exec(a3)) || (r3 && (a3 = a3.slice(r3[0].length) || a3), s3.push(i3 = [])), n3 = false, (r3 = z2.exec(a3)) && (n3 = r3.shift(), i3.push({ value: n3, type: r3[0].replace(B2, " ") }), a3 = a3.slice(n3.length)), b2.filter) !(r3 = G2[o3].exec(a3)) || u3[o3] && !(r3 = u3[o3](r3)) || (n3 = r3.shift(), i3.push({ value: n3, type: o3, matches: r3 }), a3 = a3.slice(n3.length));
        if (!n3) break;
      }
        ...
        (a3 = A2(e3, (y3 = o3, m3 = 0 < (v3 = i3).length, x3 = 0 < y3.length, r3 = function(e4, t4, n4, r4, i4) {
          ...
          for (i4 && (w2 = t4 == C2 || t4 || i4); l3 !== g3 && null != (o4 = d3[l3]); l3++) {
            if (x3 && o4) {
              ...
              while (s3 = y3[a4++]) if (s3(o4, t4 || C2, n4)) {
                r4.push(o4);
                break;
              }
              i4 && (k2 = h3);
  ...
  var B = function(e2, t2, n2, r2, i2, o2, a2) {
    ...
    if ("object" === w(n2)) for (s2 in i2 = true, n2) B(e2, t2, s2, n2[s2], true, o2, a2);
  ...
  function He(n2, r2, i2, o2) {
    ...
    if (h2 || 1 < f2 && "string" == typeof d2 && !v.checkClone && Ae.test(d2)) return n2.each(function(e3) {
      var t3 = n2.eq(e3);
    ...
    if (f2 && (t2 = (e2 = xe(r2, n2[0].ownerDocument, false, n2, o2)).firstChild, 1 === e2.childNodes.length && (e2 = t2), t2 || o2)) {
      for (s2 = (a2 = S.map(ye(e2, "script"), De)).length; c2 < f2; c2++) u2 = e2, c2 !== p2 && (u2 = S.clone(u2, true, true), s2 && S.merge(a2, ye(u2, "script"))), i2.call(n2[c2], u2, c2);
  ...
  function Oe(e2, t2, n2) {
    for (var r2, i2 = t2 ? S.filter(t2, e2) : e2, o2 = 0; null != (r2 = i2[o2]); o2++) n2 || 1 !== r2.nodeType || S.cleanData(ye(r2)), r2.parentNode && (n2 && ie(r2) && ve(ye(r2, "script")), r2.parentNode.removeChild(r2));
    return e2;
  }
  S.extend({ htmlPrefilter: function(e2) {
    ...
    if (!(v.noCloneChecked || 1 !== e2.nodeType && 11 !== e2.nodeType || S.isXMLDoc(e2))) for (a2 = ye(c2), r2 = 0, i2 = (o2 = ye(e2)).length; r2 < i2; r2++) s2 = o2[r2], u2 = a2[r2], void 0, "input" === (l2 = u2.nodeName.toLowerCase()) && pe.test(s2.type) ? u2.checked = s2.checked : "input" !== l2 && "textarea" !== l2 || (u2.defaultValue = s2.defaultValue);
    if (t2) if (n2) for (o2 = o2 || ye(e2), a2 = a2 || ye(c2), r2 = 0, i2 = o2.length; r2 < i2; r2++) Le(o2[r2], a2[r2]);
    else Le(e2, c2);
    ...
    for (var e2, t2 = 0; null != (e2 = this[t2]); t2++) 1 === e2.nodeType && (S.cleanData(ye(e2, false)), e2.textContent = "");
    return this;
    ...
    return B(this, function(e3) {
      ...
      if ("string" == typeof e3 && !ke.test(e3) && !ge[(de.exec(e3) || ["", ""])[1].toLowerCase()]) {
        ...
        try {
          for (; n2 < r2; n2++) 1 === (t2 = this[n2] || {}).nodeType && (S.cleanData(ye(t2, false)), t2.innerHTML = e3);
          t2 = 0;
        } catch (e4) {
        }
      }
  ...
  function Ve(e2) {
    ...
    return t2 || (e2 in Ue ? e2 : Xe[e2] = (function(e3) {
      ...
      while (n2--) if ((e3 = ze[n2] + t3) in Ue) return e3;
    })(e2) || e2);
  }
  ...
  S.extend({ cssHooks: { opacity: { get: function(e2, t2) {
    ...
    if (e2 && 3 !== e2.nodeType && 8 !== e2.nodeType && e2.style) {
      ...
      if (u2 || (t2 = Ve(s2)), a2 = S.cssHooks[t2] || S.cssHooks[s2], void 0 === n2) return a2 && "get" in a2 && void 0 !== (i2 = a2.get(e2, false, r2)) ? i2 : l2[t2];
    ...
    S.cssHooks[u2] = { get: function(e3, t2, n2) {
      if (t2) return !Ge.test(S.css(e3, "display")) || e3.getClientRects().length && e3.getBoundingClientRect().width ? Ze(e3, u2, n2) : Ie(e3, Ye, function() {
        return Ze(e3, u2, n2);
      });
    ...
    if (t2) return (parseFloat(Be(e2, "marginLeft")) || e2.getBoundingClientRect().left - Ie(e2, { marginLeft: 0 }, function() {
    ...
    return B(this, function(e3, t3, n2) {
      var r2, i2, o2 = {}, a2 = 0;
      if (Array.isArray(t3)) {
        for (r2 = Me(e3), i2 = t3.length; a2 < i2; a2++) o2[t3[a2]] = S.css(e3, t3[a2], false, r2);
        return o2;
      }
  ...
  S.Animation = S.extend(ft, { tweeners: { "*": [function(e2, t2) {
    ...
    if ((u2 = !S.isEmptyObject(t2)) || !S.isEmptyObject(d2)) for (r2 in f2 && 1 === e2.nodeType && (n2.overflow = [h2.overflow, h2.overflowX, h2.overflowY], null == (l2 = y2 && y2.display) && (l2 = Y.get(e2, "display")), "none" === (c2 = S.css(e2, "display")) && (l2 ? c2 = l2 : (le([e2], true), l2 = e2.style.display || l2, c2 = S.css(e2, "display"), le([e2]))), ("inline" === c2 || "inline-block" === c2 && null != l2) && "none" === S.css(e2, "float") && (u2 || (p2.done(function() {
      h2.display = l2;
    ...
    })), u2 = false, d2) u2 || (y2 ? "hidden" in y2 && (g2 = y2.hidden) : y2 = Y.access(e2, "fxshow", { display: l2 }), o2 && (y2.hidden = !g2), g2 && le([e2], true), p2.done(function() {
  ...
  S.fn.extend({ prop: function(e2, t2) {
    ...
    return m(t2) ? this.each(function(e3) {
      ...
      if (s2) for (o2 = S(this), i2 = 0; i2 < e2.length; i2++) r2 = e2[i2], o2.hasClass(r2) ? o2.removeClass(r2) : o2.addClass(r2);
      else void 0 !== t2 && "boolean" !== a2 || ((r2 = vt(this)) && Y.set(this, "__className__", r2), this.setAttribute && this.setAttribute("class", r2 || false === t2 ? "" : Y.get(this, "__className__") || ""));
    }));
  }, hasClass: function(e2) {
    var t2, n2, r2 = 0;
    t2 = " " + e2 + " ";
    while (n2 = this[r2++]) if (1 === n2.nodeType && -1 < (" " + yt(vt(n2)) + " ").indexOf(t2)) return true;
    return false;
  } });
  var xt = /\r/g;
  ...
  function jt(n2, e2, r2, i2) {
    ...
    else for (t2 in e2) jt(n2 + "[" + t2 + "]", e2[t2], r2, i2);
  }
  ...
  Wt.href = Tt.href, S.extend({ active: 0, lastModified: {}, etag: {}, ajaxSettings: { url: Tt.href, type: "GET", isLocal: /^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(Tt.protocol), global: true, processData: true, async: true, contentType: "application/x-www-form-urlencoded; charset=UTF-8", accepts: { "*": It, text: "text/plain", html: "text/html", xml: "application/xml, text/xml", json: "application/json, text/javascript" }, contents: { xml: /\bxml\b/, html: /\bhtml/, json: /\bjson\b/ }, responseFields: { xml: "responseXML", text: "responseText", json: "responseJSON" }, converters: { "* text": String, "text html": true, "text json": JSON.parse, "text xml": S.parseXML }, flatOptions: { url: true, context: true } }, ajaxSetup: function(e2, t2) {
    ...
    if (y2.data && y2.processData && "string" != typeof y2.data && (y2.data = S.param(y2.data, y2.traditional)), $t(Rt, y2, t2, T2), h2) return T2;
    for (i2 in (g2 = S.event && y2.global) && 0 == S.active++ && S.event.trigger("ajaxStart"), y2.type = y2.type.toUpperCase(), y2.hasContent = !Ot.test(y2.type), f2 = y2.url.replace(qt, ""), y2.hasContent ? y2.data && y2.processData && 0 === (y2.contentType || "").indexOf("application/x-www-form-urlencoded") && (y2.data = y2.data.replace(Dt, "+")) : (o2 = y2.url.slice(f2.length), y2.data && (y2.processData || "string" == typeof y2.data) && (f2 += (Et.test(f2) ? "&" : "?") + y2.data, delete y2.data), false === y2.cache && (f2 = f2.replace(Lt, "$1"), o2 = (Et.test(f2) ? "&" : "?") + "_=" + Ct.guid++ + o2), y2.url = f2 + o2), y2.ifModified && (S.lastModified[f2] && T2.setRequestHeader("If-Modified-Since", S.lastModified[f2]), S.etag[f2] && T2.setRequestHeader("If-None-Match", S.etag[f2])), (y2.data && y2.hasContent && false !== y2.contentType || t2.contentType) && T2.setRequestHeader("Content-Type", y2.contentType), T2.setRequestHeader("Accept", y2.dataTypes[0] && y2.accepts[y2.dataTypes[0]] ? y2.accepts[y2.dataTypes[0]] + ("*" !== y2.dataTypes[0] ? ", " + It + "; q=0.01" : "") : y2.accepts["*"]), y2.headers) T2.setRequestHeader(i2, y2.headers[i2]);
    if (y2.beforeSend && (false === y2.beforeSend.call(v2, T2, y2) || h2)) return T2.abort();
    if (u2 = "abort", b2.add(y2.complete), T2.done(y2.success), T2.fail(y2.error), c2 = $t(Mt, y2, t2, T2)) {
      if (T2.readyState = 1, g2 && m2.trigger("ajaxSend", [T2, y2]), h2) return T2;
  ...
  v.cors = !!zt && "withCredentials" in zt, v.ajax = zt = !!zt, S.ajaxTransport(function(i2) {
    var o2, a2;
    if (v.cors || zt && !i2.crossDomain) return { send: function(e2, t2) {
      var n2, r2 = i2.xhr();
  ...
  S.ajaxSetup({ jsonp: "callback", jsonpCallback: function() {
    ...
    S.cssHooks[n2] = _e(v.pixelPosition, function(e3, t2) {
      if (t2) return t2 = Be(e3, n2), Pe.test(t2) ? S(e3).position()[n2] + "px" : t2;
    });
